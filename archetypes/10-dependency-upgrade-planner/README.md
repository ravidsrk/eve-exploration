...
```bash
bash ../../scripts/run_archetype.sh archetypes/10-dependency-upgrade-planner 3210 "Review the current dependency upgrade planner queue and write a prioritized action report."
```
