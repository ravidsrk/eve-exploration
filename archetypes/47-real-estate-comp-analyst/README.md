...
```bash
bash ../../scripts/run_archetype.sh archetypes/47-real-estate-comp-analyst 3247 "Review the current real estate comp analyst queue and write a prioritized action report."
```
