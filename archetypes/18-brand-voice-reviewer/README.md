...
```bash
bash ../../scripts/run_archetype.sh archetypes/18-brand-voice-reviewer 3218 "Review the current brand voice reviewer queue and write a prioritized action report."
```
