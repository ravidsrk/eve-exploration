...
```bash
bash ../../scripts/run_archetype.sh archetypes/44-logistics-exception-monitor 3244 "Review the current logistics exception monitor queue and write a prioritized action report."
```
