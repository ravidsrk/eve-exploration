# Refund approval operator

## Rationale

Refund approval operator is a real-world eve archetype for Support Ops.
...
```bash
bash ../../scripts/run_archetype.sh archetypes/05-refund-approval-operator 3205 "Review the current refund approval operator queue and write a prioritized action report."
```
...
> Review the current refund approval operator queue and write a prioritized action report.
