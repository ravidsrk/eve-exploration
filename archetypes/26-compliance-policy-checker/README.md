...
```bash
bash ../../scripts/run_archetype.sh archetypes/26-compliance-policy-checker 3226 "Review the current compliance policy checker queue and write a prioritized action report."
```
