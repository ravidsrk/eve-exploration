...
```bash
bash ../../scripts/run_archetype.sh archetypes/29-recruiting-resume-screener 3229 "Review the current recruiting resume screener queue and write a prioritized action report."
```
