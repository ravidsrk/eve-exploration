...
```bash
bash ../../scripts/run_archetype.sh archetypes/32-knowledge-base-maintainer 3232 "Review the current knowledge base maintainer queue and write a prioritized action report."
```
