...
```bash
bash ../../scripts/run_archetype.sh archetypes/41-insurance-claims-triage 3241 "Review the current insurance claims triage queue and write a prioritized action report."
```
