...
```bash
bash ../../scripts/run_archetype.sh archetypes/07-oncall-runbook-executor 3207 "Review the current on-call runbook executor queue and write a prioritized action report."
```
