...
```bash
bash ../../scripts/run_archetype.sh archetypes/46-inventory-replenishment-planner 3246 "Review the current inventory replenishment planner queue and write a prioritized action report."
```
