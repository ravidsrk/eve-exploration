...
```bash
bash ../../scripts/run_archetype.sh archetypes/28-hr-onboarding-assistant 3228 "Review the current hr onboarding assistant queue and write a prioritized action report."
```
