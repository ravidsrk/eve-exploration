...
```bash
bash ../../scripts/run_archetype.sh archetypes/21-market-news-briefing 3221 "Review the current market/news briefing queue and write a prioritized action report."
```
