...
```bash
bash ../../scripts/run_archetype.sh archetypes/02-sales-lead-researcher 3202 "Review the current sales lead researcher queue and write a prioritized action report."
```
