...
```bash
bash ../../scripts/run_archetype.sh archetypes/45-ecommerce-merchandising-analyst 3245 "Review the current ecommerce merchandising analyst queue and write a prioritized action report."
```
