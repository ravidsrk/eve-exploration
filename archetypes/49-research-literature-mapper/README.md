...
```bash
bash ../../scripts/run_archetype.sh archetypes/49-research-literature-mapper 3249 "Review the current research literature mapper queue and write a prioritized action report."
```
