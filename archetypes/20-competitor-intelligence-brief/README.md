...
```bash
bash ../../scripts/run_archetype.sh archetypes/20-competitor-intelligence-brief 3220 "Review the current competitor intelligence brief queue and write a prioritized action report."
```
