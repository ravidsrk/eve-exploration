...
```bash
bash ../../scripts/run_archetype.sh archetypes/37-etl-data-quality-monitor 3237 "Review the current etl data quality monitor queue and write a prioritized action report."
```
