...
Support ticket triage is a real-world eve archetype for Support.
...
```bash
bash ../../scripts/run_archetype.sh archetypes/04-support-ticket-triage 3204 "Review the current support ticket triage queue and write a prioritized action report."
```
...
> Review the current support ticket triage queue and write a prioritized action report.
