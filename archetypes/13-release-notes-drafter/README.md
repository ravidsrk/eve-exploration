...
```bash
bash ../../scripts/run_archetype.sh archetypes/13-release-notes-drafter 3213 "Review the current release notes drafter queue and write a prioritized action report."
```
