...
```bash
bash ../../scripts/run_archetype.sh archetypes/31-access-request-approver 3231 "Review the current access request approver queue and write a prioritized action report."
```
