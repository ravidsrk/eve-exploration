...
```bash
bash ../../scripts/run_archetype.sh archetypes/08-cloud-cost-optimizer 3208 "Review the current cloud cost optimizer queue and write a prioritized action report."
```
