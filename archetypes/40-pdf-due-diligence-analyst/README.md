...
```bash
bash ../../scripts/run_archetype.sh archetypes/40-pdf-due-diligence-analyst 3240 "Review the current pdf due diligence analyst queue and write a prioritized action report."
```
