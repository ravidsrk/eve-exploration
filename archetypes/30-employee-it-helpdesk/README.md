...
```bash
bash ../../scripts/run_archetype.sh archetypes/30-employee-it-helpdesk 3230 "Review the current employee it helpdesk queue and write a prioritized action report."
```
