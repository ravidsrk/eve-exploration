...
```bash
bash ../../scripts/run_archetype.sh archetypes/03-crm-hygiene-auditor 3203 "Review the current crm hygiene auditor queue and write a prioritized action report."
```
