...
```bash
bash ../../scripts/run_archetype.sh archetypes/12-code-review-risk-assessor 3212 "Review the current code review risk assessor queue and write a prioritized action report."
```
