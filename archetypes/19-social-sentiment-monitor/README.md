...
```bash
bash ../../scripts/run_archetype.sh archetypes/19-social-sentiment-monitor 3219 "Review the current social sentiment monitor queue and write a prioritized action report."
```
