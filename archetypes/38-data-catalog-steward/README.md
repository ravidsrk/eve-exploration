...
```bash
bash ../../scripts/run_archetype.sh archetypes/38-data-catalog-steward 3238 "Review the current data catalog steward queue and write a prioritized action report."
```
