...
```bash
bash ../../scripts/run_archetype.sh archetypes/43-travel-operations-assistant 3243 "Review the current travel operations assistant queue and write a prioritized action report."
```
