...
```bash
bash ../../scripts/run_archetype.sh archetypes/42-healthcare-intake-summarizer 3242 "Review the current healthcare intake summarizer queue and write a prioritized action report."
```
