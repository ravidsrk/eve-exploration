...
```bash
bash ../../scripts/run_archetype.sh archetypes/23-invoice-anomaly-auditor 3223 "Review the current invoice anomaly auditor queue and write a prioritized action report."
```
