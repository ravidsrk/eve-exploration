...
```bash
bash ../../scripts/run_archetype.sh archetypes/27-privacy-dsr-responder 3227 "Review the current privacy dsr responder queue and write a prioritized action report."
```
