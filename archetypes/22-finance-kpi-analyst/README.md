...
```bash
bash ../../scripts/run_archetype.sh archetypes/22-finance-kpi-analyst 3222 "Review the current finance kpi analyst queue and write a prioritized action report."
```
