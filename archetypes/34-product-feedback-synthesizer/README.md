...
```bash
bash ../../scripts/run_archetype.sh archetypes/34-product-feedback-synthesizer 3234 "Review the current product feedback synthesizer queue and write a prioritized action report."
```
