...
```bash
bash ../../scripts/run_archetype.sh archetypes/39-code-interpreter-analyst 3239 "Review the current code interpreter analyst queue and write a prioritized action report."
```
