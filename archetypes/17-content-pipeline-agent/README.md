...
```bash
bash ../../scripts/run_archetype.sh archetypes/17-content-pipeline-agent 3217 "Review the current content pipeline agent queue and write a prioritized action report."
```
