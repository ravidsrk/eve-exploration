...
## Run
```bash
cd agents/integrations/02-web-research && npx eve dev --no-ui --port 3110
# POST a research question to /eve/v1/session and stream it
bash ../../scripts/run-catalog-agent.sh agents/integrations/02-web-research 3110 "Find recent news about OpenAI and summarize 3 headlines. Use Monid."
```
