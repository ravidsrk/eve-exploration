...
| Tool timeout (egress) | `../agents/integrations/22-security` | A timed-out sandbox command (`curl -m 8`, exit 28) is returned as a tool result the agent handles, not a crash. | SuperServe |
